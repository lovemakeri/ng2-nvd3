...
var NvD3Component = (function () {
    ...
    NvD3Component.prototype.updateWithOptions = function (options) {
      ...
      if (options.chart.yAxis10 && options.chart.type === 'multiChart') {
        ...
        if (data) {
            {
                ...
                if (!svgElement) {
                  ...
                  //   console.log('SVG element is ');
                  //
                  // for (var property1 in this.svg[0]) {
                  //   console.log(this.svg[0][property1]);
                  // }

                  //   console.dir(this.svg[0].[0]);
